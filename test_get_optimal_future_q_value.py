...
agent_pos = (2, 1)
direction = "left"
assert 4.0 == get_optimal_future_q_value(q_table, agent_pos, direction)

agent_pos = (2, 1)
direction = "up"
assert -2.0 == get_optimal_future_q_value(q_table, agent_pos, direction)

agent_pos = (1, 1)
direction = "left"
assert 4.1 == get_optimal_future_q_value(q_table, agent_pos, direction)
...
agent_pos = (1, 1)
direction = "right"
assert 1.0 == get_optimal_future_q_value(q_table, agent_pos, direction)
